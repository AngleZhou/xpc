...
- (IBAction)installExtension:(id __unused)sender {
    ...
    NSString *bundleId = @"com.ncp.estest.Extension";
	OSSystemExtensionRequest *req = [OSSystemExtensionRequest activationRequestForExtension:bundleId queue:dispatch_get_main_queue()];
...
- (void)request:(OSSystemExtensionRequest *)request didFinishWithResult:(OSSystemExtensionRequestResult)result
{
    ...
    //regitster IPC after es extension installed
    [[AppIPC sharedInstance] registerIPC];
    NSLog(@"=== AppIPC");
}
